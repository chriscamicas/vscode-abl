...
suite('OpenEdge ABL Extension Tests', () => {
    ...
    test('Test MSG_CLASSINFO Processing', (done) => {
        let msgRaw = `MSG_CLASSINFO;1;ablRunner;Progress.Lang.Object;N;NULL;P;Next-Sibling;Progress.Lang.Object;1;R;1008  (Class OpenEdge.ABLUnit.Model.TestRootModel);P;Prev-Sibling;Progress.Lang.Object;1;R;1006  (Class OpenEdge.ABLUnit.Runner.TestConfig);`;
        let msg = convertDataToDebuggerMessage(msgRaw);
    ...
    test('Test MSG_ARRAY Processing', (done) => {
        ...
        let msgRaw = `MSG_ARRAY;ext2;1;W;2"";2;W;2"";`;
        let msg = convertDataToDebuggerMessage(msgRaw);
        assert.deepEqual(msg, [
            {
                'code': 'MSG_ARRAY',
